...
- **[Product Service](../../apps/product-service/README.md)** - Product catalog and search.
...
- **[Order Service](../../apps/order-service/README.md)** - Order lifecycle and state management.
- **[Payment Service](../../apps/payment-service/README.md)** - Financial transactions and gateway integration.
- **[Analytics Service](../../apps/analytics-service/README.md)** - Event tracking and business intelligence.
